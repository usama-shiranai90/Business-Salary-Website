...
$month = null;
$achievementID = null;
if (!empty($_GET['empID']) and !empty($_GET['month'] and !empty($_GET['aid']))) {
    $id = $_REQUEST['empID'];
    $month = $_REQUEST['month'];
    $achievementID = $_REQUEST['aid'];
}

$admin = new Admin();

if (isset($_POST["submit"])){
        $admin->editEmployeeMonthlyAchievements($_POST['products'], $_POST['productPrice'], $_POST['paymentype'], $_POST['investment'], $_POST['date'], $achievementID);
        header("Location: ../Classes/AchievementDetails.php?empID=$id&month=$month");
}
?>
    ...
    <div class="formsubmission-c1">
        <form class="form-c1 container-fluid" action=" " method="post" id="contact_form">
            ...
            <div style="width: fit-content;display: flex; flex-direction: column">
                ...
                <div class="group">
                    <input name="productPrice" type="text" required="" value="<?php echo $admin->getProductPrice($achievementID)?>">
                ...
                <div class="group">
                    <input name="investment" type="text" required="" value="<?php echo $admin->getProductInvestment($achievementID)?>">
                    <span class="highlight"></span>
                    <span class="bar"></span>
