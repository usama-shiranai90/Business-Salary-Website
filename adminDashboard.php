            ...
            width: border-box;
                   ...
                   .achievementsTable td > a:hover {
                       background: rgba(0, 0, 0, 0) linear-gradient(
                               95.84deg
                               , rgb(20, 236, 31) 0%, rgb(114, 7, 7) 100%) repeat scroll 0% 0%;
                       transition: 0.4s;
                       width: 90px;
                       display: flex;
                   }
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="content">
                        ...
                        <p class="weldb-p">You can look-into your product-seller detail and other necessary information</p>
                    </div>
                </div>
            </div>
        </div>
...
<!--                        <i class="fa fa-envelope fa-fw bg-primary "></i>-->
                    ...
                    <div class="info">
                        ...
                        <h3 class="box-h3"><?php echo $admin->getMonthlyProductsSold() ?></h3> <span>Products Sold</span>
    ...
    <div class="aboutUsSection aus-c2">
        ...
        <div class="card-zero">
            ...
            <div class="card-header">
                ...
                <img class="profile-img" src="Business-Salary-Website-Files/Pictures/zero.jpeg" alt="my picture profile.">
            </div>
            <div class="card-body">
                <h2><italic>Mr</italic>.Zero</h2>
                <p>My name Zero , Dedicated and Performance-driven software engineering Intern with pro-active approach and determination to solve and successfully finish all assigned task. capable of showing firm and positive response while working under pressure. Effective team player offering extraordinary analytical skills and the important ability to think critically. Eager to absorb as much knowledge and insight as possible in pursuance of my goals.</p>
                <a href="http://google.com.pk" class="btn">check my work</a>
            </div>
